...
;;   ./icecreme/icecreme spec/creme/vm_spec.scm
;; icecreme previously had no call/cc/dynamic-wind/with-exception-handler at
;; all; all three are now real icecreme builtins (icecreme/builtins.c/vm.c/vm.h --
