;; (scheme r5rs): thin re-export frontend over (creme builtin r5rs)
(define-library (scheme r5rs)
  (import (creme builtin r5rs))
  (export * + - / < <= = > >= abs and append apply assoc assq assv begin
          ...
          newline not null-environment null? number->string number? numerator odd?
