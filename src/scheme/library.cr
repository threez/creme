...
# interpreter/library.cr for the special forms that populate/consume these.

module Scheme
  class SchemeLibrary < SchemeValue
    ...
    # for file-based libraries, see interpreter/library.cr's
    ...
    # interpreter/base_library.cr) rather than a real target.
