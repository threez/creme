...
module Scheme::Builtins::TimeLibrary
  ...
  @[Scheme::SchemeFn("time-month", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("time-day", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("time-hour", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("time-minute", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("time-second", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("time->string", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("string->time", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("time-add", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("time-difference", min: 2, max: 2)]
...
module Scheme
  class Interpreter
    register_library ["creme", "builtin", "time"], Scheme::Builtins::TimeLibrary
  end
end
