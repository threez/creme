...
module Scheme::Builtins::SecureRandomLibrary
  extend self
  include Scheme::BuiltinHelpers

  @[Scheme::SchemeFn("secure-random-bytes", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("secure-random-hex", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("secure-random-base64", min: 1, max: 1)]
...
module Scheme
  class Interpreter
    register_library ["creme", "builtin", "secure-random"], Scheme::Builtins::SecureRandomLibrary
  end
end
