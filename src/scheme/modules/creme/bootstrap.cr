...
module Scheme::Builtins::BootstrapLibrary
  extend self
  ...
  @[Scheme::SchemeFn("load-chunk-bytes", min: 1, max: 1)]
  ...
  # sentinel.
  @[Scheme::SchemeFn("expand-if-macro", min: 1, max: 1)]
