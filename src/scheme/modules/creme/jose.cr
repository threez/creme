...
module Scheme::Builtins::JoseLibrary
  extend self
  include Scheme::BuiltinHelpers

  # ── JWK ────────────────────────────────────────────────────────────────────

  @[Scheme::SchemeFn("jose-jwk-generate-oct", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-generate-ec", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-generate-rsa", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-generate-okp", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-from-oct", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-from-pem", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-from-json", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-to-pem", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-to-json", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-to-public", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-with-kid", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwk-kty", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-public?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk-private?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwk?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jws-sign", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jws-verify", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jws-sign-detached", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jws-verify-detached", min: 3, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jws-sign-json", min: 2, max: 4)]
  ...
  @[Scheme::SchemeFn("jose-jws-verify-json", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwt-sign", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jwt-verify", min: 3, max: 4)]
  def jose_jwt_verify(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    Scheme.a_to_list([
      ...
      Cons.new(SchemeStr.new("claims"), Scheme.to_scheme(jwt.to_map)).as(SchemeValue),
      Cons.new(SchemeStr.new("header"), Scheme.to_scheme(header)).as(SchemeValue),
    ])
  rescue ex : Exception
  ...
  @[Scheme::SchemeFn("jose-jwe-encrypt", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jwe-decrypt", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwe-password-encrypt", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("jose-jwe-password-decrypt", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwe-json-encrypt", min: 2, max: 4)]
  ...
  @[Scheme::SchemeFn("jose-jwe-json-decrypt", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwks-ref", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("jose-jwks-size", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("jose-jwks?", min: 1, max: 1)]
  ...
  private def jose_string_list_arg(v : SchemeValue, who : String) : Array(String)
    Scheme.list_to_a(v).map { |e| jose_str_arg(e, who) }
  end
  ...
  private def jose_convertible_to_json_any(v : Scheme::Convertible) : JSON::Any
    case v
