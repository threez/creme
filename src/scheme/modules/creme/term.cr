...
module Scheme::Builtins::Term
  ...
  @[Scheme::SchemeFn("term-raw-mode-enter!", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("term-raw-mode-exit!", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("term-read-key", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("term-move-cursor!", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("term-clear-to-eol!", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("term-write!", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("stdin-tty?", min: 0, max: 0)]
...
module Scheme
  class Interpreter
    register_library ["creme", "builtin", "term"], Scheme::Builtins::Term
  end
end
