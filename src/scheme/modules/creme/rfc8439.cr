...
module Scheme::Builtins::Rfc8439Library
  extend self
  include Scheme::BuiltinHelpers

  @[Scheme::SchemeFn("rfc8439-random-key", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("rfc8439-random-nonce", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("hex->bytevector", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("bytevector->hex", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("rfc8439-encrypt", min: 3, max: 4)]
  ...
  @[Scheme::SchemeFn("rfc8439-decrypt", min: 4, max: 4)]
  ...
  @[Scheme::SchemeFn("chacha20-encrypt", min: 3, max: 3)]
  ...
  @[Scheme::SchemeFn("poly1305-auth", min: 2, max: 2)]
