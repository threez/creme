...
module Scheme::Builtins::ActorLibrary
  extend self
  ...
  @[Scheme::SchemeFn("spawn", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("receive!", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("register!", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("whereis", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("down?", min: 1, max: 1)]
  ...
  # cookie)`.
  @[Scheme::SchemeFn("start-node", min: 3, max: 4)]
  ...
  @[Scheme::SchemeFn("node-port", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("node-path", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("node-name", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("stop-node!", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("remote-ref", min: 1, max: 1)]
