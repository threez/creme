...
module Scheme::Builtins::FileLibrary
  ...
  @[Scheme::SchemeFn("open-output-file", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("open-binary-input-file", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("open-binary-output-file", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("call-with-input-file", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("call-with-output-file", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("with-input-from-file", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("with-output-to-file", min: 2, max: 2)]
