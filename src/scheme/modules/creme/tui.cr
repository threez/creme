...
module Scheme
  ...
  # ---- Free-function helpers (used both from Scheme::Builtins::Tui and
...
module Scheme::Builtins::Tui
  extend self
  include Scheme::BuiltinHelpers

  # ---- Colors & styles ----
  @[Scheme::SchemeFn("tui-color-named", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-color-index", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-color-rgb", min: 3, max: 3)]
  ...
  @[Scheme::SchemeFn("tui-color-gray", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-style", min: 1, max: 1)]
  ...
  # ---- Screen & buffer ----
  @[Scheme::SchemeFn("tui-screen", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("tui-buffer-set!", min: 4, max: 5)]
  ...
  @[Scheme::SchemeFn("tui-buffer-clear!", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-buffer-box!", min: 5, max: 6)]
  ...
  # ---- Panes ----
  @[Scheme::SchemeFn("tui-text-edit", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-text-edit-value", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("tui-text-edit-set-highlighter!", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("tui-make-scrollable", min: 5, max: 5)]
  ...
  # ---- Layout ----
  @[Scheme::SchemeFn("tui-window", min: 2, max: 3)]
  ...
  @[Scheme::SchemeFn("tui-vstack", min: 4, max: 5)]
  ...
  @[Scheme::SchemeFn("tui-vstack-set-bottom!", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("tui-handle-key!", min: 2, max: 2)]
  ...
  # ---- Run loop ----
  @[Scheme::SchemeFn("tui-run", min: 3, max: 3)]
  def tui_run(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    runtime = TUI::Runtime.new(screen, nav, ->(ev : TUI::KeyEvent) do
      interp.apply(on_key_fn, [Scheme.tui_key_event_alist(ev).as(SchemeValue)])
      nil
    end)
    runtime.run
    NIL.as(SchemeValue)
