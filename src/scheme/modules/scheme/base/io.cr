...
module Scheme::Builtins::Io
  ...
  @[Scheme::SchemeFn("flush-output-port", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("open-input-string", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("open-output-string", min: 0, max: 0)]
  ...
  @[Scheme::SchemeFn("get-output-string", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("input-port?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("output-port?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("close-input-port", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("close-output-port", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("read-char", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("peek-char", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("read-line", min: 0, max: 1)]
  ...
  @[Scheme::SchemeFn("read-string", min: 1, max: 2)]
  ...
  @[Scheme::SchemeFn("write-char", min: 1, max: 2)]
  ...
  @[Scheme::SchemeFn("write-string", min: 1, max: 2)]
...
module Scheme
  class Interpreter
    private def install_io(env : Env) : Array(String)
      ...
      register_module(Scheme::Builtins::Io, env)
    end
