...
module Scheme::Builtins::Exceptions
  extend self
  include Scheme::BuiltinHelpers

  @[Scheme::SchemeFn("with-exception-handler", min: 2, max: 2)]
  ...
  @[Scheme::SchemeFn("raise", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("raise-continuable", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("read-error?", min: 1, max: 1)]
  ...
  @[Scheme::SchemeFn("file-error?", min: 1, max: 1)]
