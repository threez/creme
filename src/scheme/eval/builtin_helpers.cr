# ===========================================================================
# Scheme::BuiltinHelpers — stateless helpers shared by Interpreter and by
# the Scheme::Builtins::* modules
# ===========================================================================
#
# Included by Interpreter (so nothing there changes its own calling
# convention) and by every Scheme::Builtins::Xxx module (via `extend self`
...
# Interpreter itself (public where a Scheme::Builtins::* module needs it),
# reached through a builtin method's explicit `interp` parameter.

require "big"

module Scheme::BuiltinHelpers
