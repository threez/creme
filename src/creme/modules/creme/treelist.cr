...
module Creme::Builtins::Treelist
  extend self
  include Creme::BuiltinHelpers

  # -------- construction / conversion (immutable) --------

  @[Creme::SchemeFn("treelist", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("make-treelist", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("list->treelist", min: 1, max: 1)]
  def list_to_treelist(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    SchemeTreelist.new(RRB::Tree.from_array(Creme.list_to_a(args[0]))).as(SchemeValue)
  end

  @[Creme::SchemeFn("treelist->list", min: 1, max: 1)]
  def treelist_to_list(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    Creme.a_to_list(tl_arg(args[0], "treelist->list").to_a)
  end

  @[Creme::SchemeFn("vector->treelist", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist->vector", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-length", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-ref", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-first", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-last", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-add", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-cons", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-set", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("treelist-insert", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("treelist-delete", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-take", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-drop", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-take-right", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-drop-right", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-sublist", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("treelist-rest", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-append", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("treelist-reverse", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-map", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-filter", min: 2, max: 2)]
  def treelist_filter(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    kept = t.to_a.select { |v| Creme.truthy?(interp.apply(keep, [v])) }
    SchemeTreelist.new(RRB::Tree.from_array(kept)).as(SchemeValue)
  end

  @[Creme::SchemeFn("treelist-for-each", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("treelist-sort", min: 2, max: 2)]
  def treelist_sort(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    sorted = t.to_a.sort do |lhs, rhs|
      if Creme.truthy?(interp.apply(less, [lhs, rhs]))
        -1
      elsif Creme.truthy?(interp.apply(less, [rhs, lhs]))
        1
      else
        0
      end
  ...
  @[Creme::SchemeFn("treelist-member?", min: 2, max: 3)]
  ...
  @[Creme::SchemeFn("treelist-index-of", min: 2, max: 3)]
  ...
  @[Creme::SchemeFn("treelist-find", min: 2, max: 2)]
  def treelist_find(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    t.to_a.each do |v|
      return v if Creme.truthy?(interp.apply(pred, [v]))
    end
  ...
  @[Creme::SchemeFn("mutable-treelist", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("make-mutable-treelist", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("list->mutable-treelist", min: 1, max: 1)]
  def list_to_mutable_treelist(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    SchemeMutableTreelist.new(RRB::Tree.from_array(Creme.list_to_a(args[0]))).as(SchemeValue)
  end

  @[Creme::SchemeFn("vector->mutable-treelist", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("treelist-copy", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-copy", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-snapshot", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist->list", min: 1, max: 1)]
  def mutable_treelist_to_list(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    Creme.a_to_list(mtl_arg(args[0], "mutable-treelist->list").tree.to_a)
  end

  @[Creme::SchemeFn("mutable-treelist->vector", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-empty?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-length", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-ref", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-first", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-last", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-add!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-cons!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-set!", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("mutable-treelist-insert!", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("mutable-treelist-delete!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-append!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-prepend!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-take!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-drop!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-take-right!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-drop-right!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-sublist!", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("mutable-treelist-reverse!", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("mutable-treelist-map!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-sort!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-for-each", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("mutable-treelist-member?", min: 2, max: 3)]
  ...
  @[Creme::SchemeFn("mutable-treelist-find", min: 2, max: 2)]
  ...
  private def find_index(interp : Interpreter, t : RRB::Tree, needle : SchemeValue, eql : SchemeValue?, who : String) : Int32?
    ...
    t.to_a.each_with_index do |v, i|
      match = proc ? Creme.truthy?(interp.apply(proc, [needle, v])) : Creme.scheme_equal?(needle, v)
      return i if match
    end
    nil
  end
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "treelist"] do |env|
      names = register_module(Creme::Builtins::Treelist, env)
