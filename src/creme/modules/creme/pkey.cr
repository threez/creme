...
module Creme::Builtins::PKeyLibrary
  extend self
  include Creme::BuiltinHelpers

  # ── generation ────────────────────────────────────────────────────────────

  @[Creme::SchemeFn("rsa-generate-key", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("ec-generate-key", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("pkey-type", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("pkey-public-key", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("pkey-sign", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("pkey-verify", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("rsa-encrypt", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("rsa-decrypt", min: 2, max: 2)]
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "pkey"], Creme::Builtins::PKeyLibrary
  end
end
