...
module Creme::Builtins::RaftLibrary
  extend self
  include Creme::BuiltinHelpers

  # ---- logs ------------------------------------------------------------

  @[Creme::SchemeFn("raft-log-in-memory", min: 0, max: 0)]
  ...
  @[Creme::SchemeFn("raft-log?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-transport-in-memory", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-transport-in-memory-reset!", min: 0, max: 0)]
  ...
  @[Creme::SchemeFn("raft-fresh-namespace", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("raft-transport-partition!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-transport-heal!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-transport-tcp", min: 3, max: 4)]
  def raft_transport_tcp(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    Creme.list_to_a(args[2]).each do |entry|
  ...
  @[Creme::SchemeFn("raft-transport?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-config?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-state-machine", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("raft-state-machine?", min: 1, max: 1)]
  ...
  def raft_node(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    learners = args.size >= 7 ? Creme.list_to_a(args[6]).map { |v| string_arg(v, "raft-node") } : [] of String
  ...
  @[Creme::SchemeFn("raft-await-leader!", min: 1, max: 2)]
  def raft_await_leader(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    candidates = Creme.list_to_a(args[0]).map { |v| {v, raft_node_arg(v, "raft-await-leader!")} }
  ...
  @[Creme::SchemeFn("raft-propose!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-read", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-leader", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-role", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-add-peer!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-add-learner!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-promote-learner!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-remove-peer!", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("raft-snapshot!", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("raft-metrics", min: 1, max: 1)]
  ...
  private def config_bool(overrides : Hash(String, SchemeValue), key : String, default : Bool) : Bool
    overrides[key]?.try { |v| Creme.truthy?(v) } || default
  end
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "raft"], Creme::Builtins::RaftLibrary
  end
end
