...
module Creme::Builtins::Digest
  extend self
  include Creme::BuiltinHelpers

  @[Creme::SchemeFn("digest-md5", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("digest-sha1", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("digest-sha256", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("digest-sha384", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("digest-sha512", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("hmac-sha256", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("hmac-sha384", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("hmac-sha512", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("base64-encode", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("base64-decode", min: 1, max: 1)]
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "digest"], Creme::Builtins::Digest
  end
end
