...
module Creme::Builtins::X509Library
  extend self
  include Creme::BuiltinHelpers

  # ── certificate/CSR generation ─────────────────────────────────────────────

  @[Creme::SchemeFn("x509-self-signed-certificate", min: 2, max: 3)]
  ...
  @[Creme::SchemeFn("x509-create-csr", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("x509-sign-csr", min: 3, max: 4)]
  ...
  @[Creme::SchemeFn("x509-cert->pem", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("pem->x509-cert", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-cert-subject", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-cert-issuer", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-cert-public-key", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-cert-not-before", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-cert-not-after", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("x509-verify-chain", min: 2, max: 2)]
  ...
  private def x509_cert_list_arg(v : SchemeValue, who : String) : Array(String)
    raise SchemeRuntimeError.new("#{who}: expected a list of x509 certificates") unless Creme.proper_list?(v)
    Creme.list_to_a(v).map { |cert_value| x509_cert_arg(cert_value, who) }
  end

  private def x509_subject_arg(v : SchemeValue, who : String) : Array({String, String})
    raise SchemeRuntimeError.new("#{who}: expected an alist of (field . value) pairs") unless Creme.proper_list?(v)
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "x509"], Creme::Builtins::X509Library
  end
end
