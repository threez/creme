...
module Creme::Builtins::CipherLibrary
  extend self
  ...
  @[Creme::SchemeFn("aes-256-gcm-random-key", min: 0, max: 0)]
  ...
  @[Creme::SchemeFn("aes-256-gcm-random-nonce", min: 0, max: 0)]
  ...
  @[Creme::SchemeFn("aes-256-gcm-encrypt", min: 3, max: 4)]
  ...
  @[Creme::SchemeFn("aes-256-gcm-decrypt", min: 4, max: 5)]
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "cipher"], Creme::Builtins::CipherLibrary
  end
end
