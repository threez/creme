...
module Creme::R7RS::Bytevectors
  ...
  @[Creme::SchemeFn("make-bytevector", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("bytevector-length", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("bytevector-u8-ref", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("bytevector-u8-set!", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("bytevector-copy", min: 1, max: 3)]
  ...
  @[Creme::SchemeFn("bytevector-copy!", min: 3, max: 5)]
  ...
  @[Creme::SchemeFn("bytevector-append", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("utf8->string", min: 1, max: 3)]
  ...
  @[Creme::SchemeFn("string->utf8", min: 1, max: 3)]
  ...
  @[Creme::SchemeFn("open-input-bytevector", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("open-output-bytevector", min: 0, max: 0)]
  ...
  @[Creme::SchemeFn("get-output-bytevector", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("read-u8", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("peek-u8", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("u8-ready?", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("write-u8", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("read-bytevector", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("read-bytevector!", min: 1, max: 4)]
  ...
  @[Creme::SchemeFn("write-bytevector", min: 1, max: 4)]
  ...
  @[Creme::SchemeFn("binary-port?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("textual-port?", min: 1, max: 1)]
  def textual_port_p(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    SchemeBool.of(args[0].is_a?(SchemePort) && !args[0].as(SchemePort).binary?)
  end

  @[Creme::SchemeFn("input-port-open?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("output-port-open?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-ready?", min: 0, max: 1)]
  ...
  @[Creme::SchemeFn("call-with-port", min: 2, max: 2)]
...
module Creme
  class Interpreter
    private def install_bytevectors(env : Env) : Array(String)
      register_module(Creme::R7RS::Bytevectors, env)
    end
  end
end
