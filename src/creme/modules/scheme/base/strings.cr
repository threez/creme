...
module Creme::R7RS::Strings
  extend self
  include Creme::BuiltinHelpers

  @[Creme::SchemeFn("string-append", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("string-length", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("substring", min: 2, max: 3)]
  ...
  @[Creme::SchemeFn("string->symbol", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("symbol->string", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("symbol=?", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("boolean=?", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("string->number", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("string=?", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("string-ref", min: 2, max: 2)]
  ...
  @[Creme::SchemeFn("string->list", min: 1, max: 3)]
  def string_to_list(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    ...
    Creme.a_to_list(chars[first...last].map { |chr| SchemeChar.new(chr).as(SchemeValue) })
  end

  @[Creme::SchemeFn("list->string", min: 1, max: 1)]
  def list_to_string(interp : Interpreter, env : Env, args : Array(SchemeValue)) : SchemeValue
    buf = String::Builder.new
    Creme.list_to_a(args[0]).each do |v|
  ...
  @[Creme::SchemeFn("string", min: 0, max: -1)]
  ...
  @[Creme::SchemeFn("string-map", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("string-for-each", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("string-copy", min: 1, max: 3)]
  ...
  # mutating in place.
  @[Creme::SchemeFn("string-copy!", min: 3, max: 5)]
  ...
  @[Creme::SchemeFn("string-set!", min: 3, max: 3)]
  ...
  @[Creme::SchemeFn("string-fill!", min: 2, max: 4)]
  ...
  @[Creme::SchemeFn("string->vector", min: 1, max: 3)]
  ...
  @[Creme::SchemeFn("vector->string", min: 1, max: 3)]
  ...
  @[Creme::SchemeFn("make-string", min: 1, max: 2)]
  ...
  @[Creme::SchemeFn("char->integer", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("integer->char", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char=?", min: 2, max: -1)]
...
module Creme
  class Interpreter
    private def install_strings(env : Env) : Array(String)
      register_module(Creme::R7RS::Strings, env)
    end
  end
end
