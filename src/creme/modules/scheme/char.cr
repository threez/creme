...
module Creme::R7RS::CharLibrary
  ...
  @[Creme::SchemeFn("string-foldcase", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("string-ci=?", min: 2, max: -1)]
  ...
  @[Creme::SchemeFn("char-upcase", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-downcase", min: 1, max: 1)]
  ...
  # otherwise handles.
  @[Creme::SchemeFn("char-foldcase", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("digit-value", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-alphabetic?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-numeric?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-whitespace?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-upper-case?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-lower-case?", min: 1, max: 1)]
  ...
  @[Creme::SchemeFn("char-ci=?", min: 2, max: -1)]
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "char"], Creme::R7RS::CharLibrary
  end
end
