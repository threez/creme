...
module Creme::R7RS::LazyLibrary
  ...
  @[Creme::SchemeFn("force", min: 1, max: 1)]
...
module Creme
  class Interpreter
    register_library ["creme", "builtin", "lazy"] do |env|
      own = register_module(Creme::R7RS::LazyLibrary, env)
