# ===========================================================================
# Annotation-driven builtin registration: @[Creme::SchemeFn(...)]
# ===========================================================================
#
# A library module (e.g. Creme::R7RS::Predicates) declares one method
# per builtin, each annotated with its Scheme name and arity:
#
#   module Creme::Builtins::Xxx
#     extend self
#     include Creme::BuiltinHelpers
#
#     @[Creme::SchemeFn("some-name", min: 1, max: 1)]
...
#   module Creme
#     class Interpreter
#       register_library ["scheme", "xxx"], Creme::Builtins::Xxx
#     end
#   end
#
# `Interpreter#register_module` scans a module's methods at compile time for
# the @[Creme::SchemeFn] annotation and generates one `Builtin.new(...)`
...
#
# - `register_library ["scheme", "xxx"], Creme::Builtins::Xxx` — the common
  ...
  class Interpreter
    ...
    macro register_module(mod, env)
      ...
      {% for method in mod.resolve.methods %}
        {% ann = method.annotation(Creme::SchemeFn) %}
        {% if ann %}
