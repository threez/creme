...
#ifndef CREME_PROFILER_H
#define CREME_PROFILER_H
 ...
 * the CURRENT top frame (already cached as a local in creme_dispatch), about
 ...
 * program; creme_profiler_stop_native must be called before the process exits
 ...
 * stdout. Call after creme_profiler_stop_native. */
