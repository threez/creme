 ...
 *
 * Every op has a real entry here, including ones icecreme/vm.c doesn't
 * implement yet (see icecreme/README.md for current coverage) — their
...
enum {
   ...
   * icecreme's own in-process call-site quickening: vm.c's OP_CALLGLOBAL case
   ...
   * doc/optimization-icecreme.md Section 3), so any 3-arg `+` call always
