 ...
 * which backend (icecreme or native/self-hosted Crystal) it's running under.
 *
 ...
 * because icecreme couldn't use termios directly, but so both backends flip the
 ...
 * identically under bin/creme, --self-hosted, and icecreme/icecreme. */
